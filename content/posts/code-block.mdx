...
[0;36m  [0;2m8:38:02 PM[0m [0;36;1m[vite][0m [0;32mhmr update [0;2m/src/App.jsx
```

Inline ANSI: > `[0;36mhttp://localhost:[0;36;1m3000[0;36m/[0m{:ansi}`
...
function isEven(number) {
  if (number === 1) {
    ...
    return false;
  } else if (number === 6) { // [!code --]
    return true; // [!code --]
  } else if (number === 7) { // [!code ++]
    return false; // [!code ++]
  } else if (number === 8) {
    return true;
  } else if (number === 9) {
